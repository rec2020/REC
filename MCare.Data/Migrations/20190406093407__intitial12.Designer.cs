...
namespace NajmetAlraqee.Data.Migrations
{
    ...
    [Migration("20190406093407__intitial12")]
    partial class _intitial12
    {
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.Contract", b =>
                {
                    ...
                    b.HasIndex("ArrivalCityId")
                        .IsUnique()
                        .HasFilter("[ArrivalCityId] IS NOT NULL");

                    b.HasIndex("ContractStatusId")
                        .IsUnique()
                        .HasFilter("[ContractStatusId] IS NOT NULL");

                    b.HasIndex("ContractTypeId")
                        .IsUnique()
                        .HasFilter("[ContractTypeId] IS NOT NULL");
                    ...
                    b.HasIndex("ForeignAgencyId")
                        .IsUnique()
                        .HasFilter("[ForeignAgencyId] IS NOT NULL");
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.ContractDelegation", b =>
                {
                    ...
                    b.HasIndex("DelegateById")
                        .IsUnique()
                        .HasFilter("[DelegateById] IS NOT NULL");
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.ContractHistory", b =>
                {
                    ...
                    b.HasIndex("ActionById")
                        .IsUnique()
                        .HasFilter("[ActionById] IS NOT NULL");
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.ContractSelect", b =>
                {
                    ...
                    b.HasIndex("SelectById")
                        .IsUnique()
                        .HasFilter("[SelectById] IS NOT NULL");
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.ContractTicket", b =>
                {
                    ...
                    b.HasIndex("TicketById")
                        .IsUnique()
                        .HasFilter("[TicketById] IS NOT NULL");
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.ContractVisa", b =>
                {
                    ...
                    b.HasIndex("VisaById")
                        .IsUnique()
                        .HasFilter("[VisaById] IS NOT NULL");
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.Currency", b =>
                {
                    ...
                    b.HasIndex("CurrencyTypeId")
                        .IsUnique()
                        .HasFilter("[CurrencyTypeId] IS NOT NULL");
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.Employee", b =>
                {
                    ...
                    b.HasIndex("ReligionId")
                        .IsUnique()
                        .HasFilter("[ReligionId] IS NOT NULL");

                    b.HasIndex("SocialStatusId")
                        .IsUnique()
                        .HasFilter("[SocialStatusId] IS NOT NULL");
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.Contract", b =>
                {
                    b.HasOne("NajmetAlraqee.Data.Entities.City", "ArrivalCity")
                        .WithOne("Contract")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Contract", "ArrivalCityId");

                    b.HasOne("NajmetAlraqee.Data.Entities.ContractStatus", "ContractStatus")
                        .WithOne("Contract")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Contract", "ContractStatusId");

                    b.HasOne("NajmetAlraqee.Data.Entities.ContractType", "ContractType")
                        .WithOne("Contract")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Contract", "ContractTypeId");

                    b.HasOne("NajmetAlraqee.Data.Entities.Customer", "Customer")
                        .WithOne("Contract")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Contract", "CustomerId");

                    b.HasOne("NajmetAlraqee.Data.Entities.Employee", "Employees")
                        .WithOne("Contract")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Contract", "EmployeeId");

                    b.HasOne("NajmetAlraqee.Data.Entities.ForeignAgency", "ForeignAgency")
                        .WithOne("Contract")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Contract", "ForeignAgencyId");

                    b.HasOne("NajmetAlraqee.Data.Entities.JobType", "JobType")
                        .WithOne("Contract")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Contract", "JobTypeId");
                });
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.ContractDelegation", b =>
                {
                    ...
                    b.HasOne("NajmetAlraqee.Data.Entities.User", "DelegateBy")
                        .WithOne("ContractDelegation")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractDelegation", "DelegateById");

                    b.HasOne("NajmetAlraqee.Data.Entities.ForeignAgency", "ForeignAgency")
                        .WithOne("ContractDelegation")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractDelegation", "ForeignAgencyId");
                });

            modelBuilder.Entity("NajmetAlraqee.Data.Entities.ContractHistory", b =>
                {
                    b.HasOne("NajmetAlraqee.Data.Entities.User", "ActionBy")
                        .WithOne("ContractHistory")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractHistory", "ActionById");

                    b.HasOne("NajmetAlraqee.Data.Entities.ContractAction", "Action")
                        .WithOne("ContractHistory")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractHistory", "ActionId");
                    ...
                    b.HasOne("NajmetAlraqee.Data.Entities.ContractStatus", "ContractStatus")
                        .WithOne("ContractHistory")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractHistory", "ContractStatusId");

                    b.HasOne("NajmetAlraqee.Data.Entities.Customer", "Customer")
                        .WithOne("ContractHistory")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractHistory", "CustomerId");

                    b.HasOne("NajmetAlraqee.Data.Entities.Employee", "Employee")
                        .WithOne("ContractHistory")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractHistory", "EmployeeId");

                    b.HasOne("NajmetAlraqee.Data.Entities.ForeignAgency", "ForeignAgency")
                        .WithOne("ContractHistory")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractHistory", "ForeignAgencyId");
                });
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.ContractSelect", b =>
                {
                    ...
                    b.HasOne("NajmetAlraqee.Data.Entities.ForeignAgency", "ForeignAgency")
                        .WithOne("ContractSelect")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractSelect", "ForeignAgencyId");

                    b.HasOne("NajmetAlraqee.Data.Entities.User", "SelectBy")
                        .WithOne("ContractSelect")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractSelect", "SelectById");
                });

            modelBuilder.Entity("NajmetAlraqee.Data.Entities.ContractTicket", b =>
                {
                    b.HasOne("NajmetAlraqee.Data.Entities.City", "City")
                        .WithOne("ContractTicket")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractTicket", "CityId");
                    ...
                    b.HasOne("NajmetAlraqee.Data.Entities.Employee", "Employee")
                        .WithOne("ContractTicket")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractTicket", "EmployeeId");

                    b.HasOne("NajmetAlraqee.Data.Entities.User", "TicketBy")
                        .WithOne("ContractTicket")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractTicket", "TicketById");
                });
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.ContractVisa", b =>
                {
                    ...
                    b.HasOne("NajmetAlraqee.Data.Entities.Employee", "Employee")
                        .WithOne("ContractVisa")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractVisa", "EmployeeId");

                    b.HasOne("NajmetAlraqee.Data.Entities.User", "VisaBy")
                        .WithOne("ContractVisa")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ContractVisa", "VisaById");
                });
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.Currency", b =>
                {
                    b.HasOne("NajmetAlraqee.Data.Entities.CurrencyType", "CurrencyType")
                        .WithOne("Currency")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Currency", "CurrencyTypeId");
                });
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.Customer", b =>
                {
                    b.HasOne("NajmetAlraqee.Data.Entities.CustomerType", "CustomerType")
                        .WithOne("Customer")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Customer", "CustomerTypeId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("NajmetAlraqee.Data.Entities.Employee", b =>
                {
                    b.HasOne("NajmetAlraqee.Data.Entities.EmployeeStatus", "EmployeeStatus")
                        .WithOne("Employee")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Employee", "EmployeeStatusId");

                    b.HasOne("NajmetAlraqee.Data.Entities.ForeignAgency", "ForeignAgency")
                        .WithOne("Employee")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Employee", "ForeignAgencyId");

                    b.HasOne("NajmetAlraqee.Data.Entities.Gender", "Gender")
                        .WithOne("Employee")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Employee", "GenderId");

                    b.HasOne("NajmetAlraqee.Data.Entities.JobType", "JobType")
                        .WithOne("Employee")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Employee", "JobTypeId");

                    b.HasOne("NajmetAlraqee.Data.Entities.Nationality", "Nationality")
                        .WithOne("Employee")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Employee", "NationalityId");

                    b.HasOne("NajmetAlraqee.Data.Entities.Religion", "Religion")
                        .WithOne("Employee")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Employee", "ReligionId");

                    b.HasOne("NajmetAlraqee.Data.Entities.SocialStatus", "SocialStatus")
                        .WithOne("Employee")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.Employee", "SocialStatusId");
                });

            modelBuilder.Entity("NajmetAlraqee.Data.Entities.ForeignAgency", b =>
                {
                    b.HasOne("NajmetAlraqee.Data.Entities.BankDetail", "BankDetail")
                        .WithOne("ForeignAgency")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ForeignAgency", "BankDetailId");

                    b.HasOne("NajmetAlraqee.Data.Entities.Currency", "Currency")
                        .WithOne("ForeignAgency")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ForeignAgency", "CurrencyId");

                    b.HasOne("NajmetAlraqee.Data.Entities.JobType", "JobType")
                        .WithOne("ForeignAgency")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ForeignAgency", "JobTypeId");

                    b.HasOne("NajmetAlraqee.Data.Entities.Nationality", "Nationality")
                        .WithOne("ForeignAgency")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.ForeignAgency", "NationalityId");
                });

            modelBuilder.Entity("NajmetAlraqee.Data.Entities.UserDelegate", b =>
                {
                    b.HasOne("NajmetAlraqee.Data.Entities.DelegateType", "DelegateType")
                        .WithOne("UserDelegate")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.UserDelegate", "DelegateTypeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("NajmetAlraqee.Data.Entities.Nationality", "Nationality")
                        .WithOne("UserDelegate")
                        .HasForeignKey("NajmetAlraqee.Data.Entities.UserDelegate", "NationalityId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
